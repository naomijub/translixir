defmodule Translixir.Model.HistoryTimeRange do
  @moduledoc """
    ```
    Translixir.Model.HistoryTimeRange{
  ...
  @type t(start_valid_time, end_valid_time, start_tx_time, end_tx_time) ::
          %Translixir.Model.HistoryTimeRange{
            start_valid_time: start_valid_time,
            end_valid_time: end_valid_time,
            start_tx_time: start_tx_time,
            end_tx_time: end_tx_time
          }
